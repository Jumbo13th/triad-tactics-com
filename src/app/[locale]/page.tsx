...
import { getShowcaseStandings } from '@/features/stats/useCases/getShowcaseStandings';
...
export default async function HomePage({ params }: { params: Promise<{ locale: string }> }) {
	...
	let topUnits: { seasonName: string; rows: ReturnType<typeof getShowcaseStandings>['rows'] } | null = null;
	try {
		if (!getStatsVisibility(statsDeps).hidden) {
			const standings = getShowcaseStandings(statsDeps);
